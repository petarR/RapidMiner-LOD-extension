...
public class RDFWLSubTreeKernelOperator extends AbstractKernelOperator {
	...
	public void generateFeatureVectors() {
		switch (option) {
		case 0: kernel = new RDFWLSubTreeKernel(nmIterations, graphDepth, useInference, true, false, normalizeValues); break;
		case 1: kernel = new RDFRootWLSubTreeKernel(nmIterations, useInference, normalizeValues); break;
		case 2: kernel = new RDFTreeWLSubTreeKernel(nmIterations, graphDepth, useInference, true, false, normalizeValues); break;
