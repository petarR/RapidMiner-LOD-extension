...
public class SPARQLConfigurable extends AbstractConfigurable {
	...
	public SPARQLEndpointQueryRunner getTheRunnerFromDialog(
		...
		int runnerType = Integer
				.parseInt(getParameter(SPARQLConfigurator.RUNNER_TYPE));
		...
		case 1:
			...
			int reasonerIndex = Integer
					.parseInt(getParameter(SPARQLConfigurator.LOCAL_REASONER));
