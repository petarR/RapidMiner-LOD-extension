...
public class RDFTreePathCountKernelOperator extends AbstractKernelOperator {

	public RDFTreePathCountKernelOperator(OperatorDescription description) {
		super(description);
	...
	public void generateFeatureVectors() {
		...
		kernel = new RDFTreePathCountKernel(pathDepth, graphDepth,
