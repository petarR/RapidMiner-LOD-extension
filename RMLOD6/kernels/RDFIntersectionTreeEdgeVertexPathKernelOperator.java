...
public class RDFIntersectionTreeEdgeVertexPathKernelOperator extends
		AbstractKernelOperator {

	public RDFIntersectionTreeEdgeVertexPathKernelOperator(
	...
	public void generateFeatureVectors() {
		kernel = new RDFIntersectionTreeEdgeVertexPathKernel(pathDepth,
