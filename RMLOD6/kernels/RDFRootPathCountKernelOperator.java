...
public class RDFRootPathCountKernelOperator extends AbstractKernelOperator {

	public static final String PARAMETER_USE_ROOT_NODE = "Use root node";

	public RDFRootPathCountKernelOperator(OperatorDescription description) {
		super(description);
	...
	public List<ParameterType> getParameterTypes() {
		...
		types.add(new ParameterTypeInt(PARAMETER_PATH_DEPTH, "Path length", 1,
				5, 1, false));
		types.add(new ParameterTypeBoolean(PARAMETER_USE_ROOT_NODE,
				"Use the root node", false, false));
	...
	public void generateFeatureVectors() {
		...
		kernel = new RDFRootPathCountKernel(pathDepth, graphDepth,
				getParameterAsBoolean(PARAMETER_USE_ROOT_NODE), useInference,
				normalizeValues);
