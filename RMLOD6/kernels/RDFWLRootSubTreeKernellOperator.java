...
public class RDFWLRootSubTreeKernellOperator extends AbstractKernelOperator {

	public static final String PARAMETER_NM_ITERATIONS = "Number of Iterations";

	private int nmIterations = 0;

	public RDFWLRootSubTreeKernellOperator(OperatorDescription description) {
		super(description);
	...
	public void generateFeatureVectors() {
		...
		kernel = new RDFWLRootSubTreeKernel(nmIterations, graphDepth,
