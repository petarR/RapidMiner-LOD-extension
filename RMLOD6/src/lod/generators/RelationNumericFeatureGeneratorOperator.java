 ...
 * 
 */
public class RelationNumericFeatureGeneratorOperator extends BaseGenerator {

	private static final String CLASS_NAME = "relation_numeric_feature_generator_operator";

	private static final String IN_REPLACE = "in_numeric_";

	private static final String OUT_REPLACE = "out_numeric_";

	public RelationNumericFeatureGeneratorOperator(
	...
	public void doWork() throws OperatorException {
		...
		for (int i = 0; i < attrsBypsass.size(); i++) {
			...
			extendAttributeSet(uniqueAttributesToAdd, attributeNamePrefix,
					...
					Generators.RELATION_NUMERIC_FEATURE, "_");
			// /////END
		}
	...
	protected String getSPARQLQueryOutgoingWithCount(String uri) {
		String query = "SELECT DISTINCT (count(*) as ?relations) ?p "
				+ "WHERE {<" + uri + "> ?p _:o .}";

		return createFilteredQuery(query, "?p", null) + " group by ?p";
	}
