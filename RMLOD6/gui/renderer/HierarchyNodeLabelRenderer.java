...
import com.rapidminer.gui.graphs.TreeModelNodeLabelRenderer.OutsidePositioner;
...
public class HierarchyNodeLabelRenderer<V, E> implements Renderer.VertexLabel<V, E> {
	...
	public HierarchyNodeLabelRenderer(HierarchyGraphCreator graphCreator) {
